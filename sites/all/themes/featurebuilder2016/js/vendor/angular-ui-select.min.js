 ...
 * Version: 0.16.1 - 2016-05-05T18:57:26.448Z
 * License: MIT
 */
...
uis.directive('uiSelectChoices',
  ...
  return {
    ...
    compile: function(tElement, tAttrs) {
      ...
      clickTarget.attr('ng-mouseenter', '$select.setActiveItem('+parserResult.itemName +')').attr('ng-click', '$select.select(' + parserResult.itemName + ',$select.skipFocusser,$event)');
...
$templateCache.put("select2/match-multiple.tpl.html","<span class=\"ui-select-match\"><li class=\"ui-select-match-item select2-search-choice\" ng-repeat=\"$item in $select.selected\" data-tooltip aria-haspopup=\"true\" data-options=\"disable_for_touch:true\" class=\"has-tip\" title=\"{{$item.Name}}\" ng-class=\"{\'select2-search-choice-focus\':$selectMultiple.activeMatchIndex === $index, \'select2-locked\':$select.isLocked(this, $index)}\" ui-select-sort=\"$select.selected\"><span uis-transclude-append=\"\"></span> <a href=\"javascript:;\" class=\"ui-select-match-close select2-search-choice-close\" ng-click=\"$selectMultiple.removeChoice($index)\" tabindex=\"-1\"></a></li></span>");
